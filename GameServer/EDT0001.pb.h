...
class MOTOR final :
 ...
 public:
  ...
  // int32 MOTOR_ = 1;
  void clear_motor_();
  int32_t motor_() const;
  void set_motor_(int32_t value);
  private:
  int32_t _internal_motor_() const;
  void _internal_set_motor_(int32_t value);
  public:
...
// int32 MOTOR_ = 1;
inline void MOTOR::clear_motor_() {
  _impl_.motor__ = 0;
}
inline int32_t MOTOR::_internal_motor_() const {
  return _impl_.motor__;
}
inline int32_t MOTOR::motor_() const {
  // @@protoc_insertion_point(field_get:Protocol.MOTOR.MOTOR_)
  return _internal_motor_();
}
inline void MOTOR::_internal_set_motor_(int32_t value) {
  
  _impl_.motor__ = value;
}
inline void MOTOR::set_motor_(int32_t value) {
  _internal_set_motor_(value);
  // @@protoc_insertion_point(field_set:Protocol.MOTOR.MOTOR_)
}
...
// int32 INT = 1;
inline void INVERTER::clear_int_() {
  _impl_.int__ = 0;
}
inline int32_t INVERTER::_internal_int_() const {
  return _impl_.int__;
}
inline int32_t INVERTER::int_() const {
  // @@protoc_insertion_point(field_get:Protocol.INVERTER.INT)
  return _internal_int_();
}
inline void INVERTER::_internal_set_int_(int32_t value) {
  
  _impl_.int__ = value;
}
inline void INVERTER::set_int_(int32_t value) {
  _internal_set_int_(value);
  // @@protoc_insertion_point(field_set:Protocol.INVERTER.INT)
}
