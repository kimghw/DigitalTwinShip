...
const uint32_t TableStruct_Protobuf_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::C_TEST, _impl_.test_),
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 7, -1, -1, sizeof(::Protocol::C_TEST)},
  { 14, -1, -1, sizeof(::Protocol::S_TEST)},
};
...
const char descriptor_table_protodef_Protobuf_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\016Protobuf.proto\022\010Protocol\"\026\n\006H_TEST\022\014\n\004"
...
const ::_pbi::DescriptorTable descriptor_table_Protobuf_2eproto = {
    false, false, 106, descriptor_table_protodef_Protobuf_2eproto,
    "Protobuf.proto",
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "Protocol.C_TEST.test"));
        } else
          goto handle_unusual;
        continue;
      default:
