...
inline uint32_t S_TEST::_internal_id() const {
  return _impl_.id_;
}
inline uint32_t S_TEST::id() const {
  // @@protoc_insertion_point(field_get:Protocol.S_TEST.Id)
  return _internal_id();
}
inline void S_TEST::_internal_set_id(uint32_t value) {
  
  _impl_.id_ = value;
}
inline void S_TEST::set_id(uint32_t value) {
